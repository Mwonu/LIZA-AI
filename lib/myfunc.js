 ...
 * Optimized for AlwaysData/Railway
...
/**
 * Serialize Message - LIZA-AI Version (Enhanced)
 */
exports.smsg = (sock, m, store) => {
    ...
    if (m.message) {
        ...
        // --- നവീകരിച്ച ബോഡി ഡിറ്റക്ഷൻ ലോജിക് ---
    ...
    m.text = m.msg.text || m.msg.caption || m.message.conversation || m.body || ''
